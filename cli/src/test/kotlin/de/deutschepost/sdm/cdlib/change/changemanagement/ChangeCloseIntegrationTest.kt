...
class ChangeCloseIntegrationTest(
    ...
    init {
        companion object {
            const val PUSHING_METRIC_OBJECT_MESSAGE = "Pushing following metric object:"
        }
        ...
        "Closing change successfully publishes metrics via Jenkins" {
            withEnvironment(
                ...
                const val DASHBOARD_STATUS_201 = "Dashboard status code: 201"
                                output shouldContain "http://integration-test-url.jenkuns.example.com"
                                output shouldContain DASHBOARD_STATUS_201
