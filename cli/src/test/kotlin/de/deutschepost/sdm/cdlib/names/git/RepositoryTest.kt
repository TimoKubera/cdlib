...
class RepositoryTest : AnnotationSpec() {
    ...
    companion object {
        const val DUMMY_EMAIL = "f.l@dhl.com"
    }
    ...
    fun initMocks() {
        ...
        every { GitRepository.lastBranchCommit(any()) } returns GitRevision(
            ...
            authorEmail = DUMMY_EMAIL,
            committerName = "Firstname Lastname",
            committerEmail = DUMMY_EMAIL
        )
    }
    ...
    fun testLastCommit() {
        ...
        revision.authorEmail shouldBeEqualComparingTo DUMMY_EMAIL
        revision.committerName shouldBeEqualComparingTo "Firstname Lastname"
        revision.committerEmail shouldBeEqualComparingTo DUMMY_EMAIL
    }
