    ...
    class FetchCommand : SubcommandWithHelp() {
        ...
        class CSSCommand : SubcommandWithHelp(), Callable<Int> {
            ...
            override fun call(): Int = runBlocking {
                ...
                if (!isRegistryValid(registry)) return@runBlocking -1
                ...
                if (!checkIfImageIsPresentInHarbor(registry, project, repository, reference, auth)) {
                    return@runBlocking -1
                }
            
                if (pollCCAScanStatus(registry, project, repository, reference, auth, cssTimeout) != 0) {
                    return@runBlocking -1
                }
            ...
            private fun isRegistryValid(registry: String): Boolean {
            ...
            private fun checkIfImageIsPresentInHarbor(
                registry: String,
                project: String,
                repository: String,
                reference: String,
