    ...
    class FetchCommand : SubcommandWithHelp() {
        ...
        class CSSCommand : SubcommandWithHelp(), Callable<Int> {
            ...
            override fun call(): Int = runBlocking {
                ...
                validateRegistry(registry) ?: return@runBlocking -1
                val (repository, reference) = parseRepository(repositoryReference) ?: return@runBlocking -1
                ...
                checkImagePresence(registry, project, repository, reference, auth) ?: return@runBlocking -1
            
                performScan(registry, project, repository, reference, auth) ?: return@runBlocking -1
                ...
                val ccaSuppressionList = getCveAllowList(registry, project, auth) ?: return@runBlocking -1
            ...
            private fun validateRegistry(registry: String): Unit? {
            ...
            private fun parseRepository(repositoryReference: String): Pair<String, String>? {
                return runCatching {
