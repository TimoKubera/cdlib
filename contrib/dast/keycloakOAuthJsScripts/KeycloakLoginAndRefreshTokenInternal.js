...
function authenticate(helper, paramsValues, credentials) {
    ...
    if (!current_access_token) {
        ...
        var client_secret = credentials.getParam("client_secret"); // paramsValues.get("client_secret");

        // Build body
        var getTokenBody = "client_id=" + client_id;
        getTokenBody+= "&grant_type=client_credentials&scope=openid";
        getTokenBody+= "&client_secret=" + client_secret;
